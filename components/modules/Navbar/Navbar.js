        ...
        <nav className={`${style.navbar} ${style.navbar_expand_lg} bg-none navbar-dark py-3`}>
            ...
            <div className={`collapse ${style.navbar_collapse} justify-content-between`} id="navbarCollapse">
                <div className={`${style.navbar_nav} ml-auto p-4`}>
                    <Link href="/" className={`${style.nav_link} nav-item active`}>Home</Link>
                    <Link href="/about" className={`${style.nav_link} nav-item active`}>About</Link>
                    <Link href="/services" className={`${style.nav_link} nav-item ${style.active_nav_link}`}>Service</Link>
                    <Link href="/menu" className={`${style.nav_link} nav-item active`}>Menu</Link>
                    <div className={`nav-item ${style.dropdown}`}>
                        ...
                        <div className={`${style.dropdown_menu} text-capitalize`}>
                            <Link href="/reservation" className={style.dropdown_item}>Reservation</Link>
                            <Link href="/testimonial" className={style.dropdown_item}>Testimonial</Link>
                        </div>
                    </div>
                    <Link href="/contact" className={`${style.nav_link} nav-item active`}>Contact</Link>
                </div>
            </div>
        </nav>
    </div>
